...
To test HPO enrichment between cases and controls, run:

```bash
python scripts/9_hpo_case_control_enrichment.py \
  --input-tsv participants_hpo.tsv \
  --out hpo_case_control_enrichment.tsv
```
