...
def read_gene_tsv(path):
    ...
    with open(path, newline="") as fh:
        ...
        required = {"platekey", "gene_name", "gene_id", "variant_id", "genotype", "AF", "AC", "AN"}
...
def main():
    ...
    with open(args.out, "w", newline="") as fh:
        writer = csv.DictWriter(
            fh,
            delimiter="\t",
            fieldnames=["platekey", "gene_name", "gene_id", "n_homozygous_variants", "variant_ids", "genotypes", "AF", "AC", "AN", "gene_tsv"],
        )
        writer.writeheader()
